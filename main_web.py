...
# Valores padrão definidos antes do central_state para evitar NameError na inicialização.
# Serão sobrescritos logo abaixo caso haja configuração persistida no banco.
...
# RISK_MODE e MAX_MOEDAS_ATIVAS são definidos antes do central_state (ver acima)
# e atualizados pela restauração do banco logo após. Não redefinir aqui para não
# sobrescrever o valor persistido.
