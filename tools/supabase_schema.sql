...
alter table public.clientes add column if not exists exchange text not null default 'bybit';
...
-- Ensure all existing records have a valid exchange value (default to 'bybit' for backward compatibility)
update public.clientes
set exchange = 'bybit'
